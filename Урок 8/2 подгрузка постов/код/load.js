...
function init() {
    ...
    // почему-то offsetHight у body при загрузке всегда на 1 пиксель больше.
    //Добавил вычитание этого пикселя в проверку условия, но кажется этот способ не очень надежным
